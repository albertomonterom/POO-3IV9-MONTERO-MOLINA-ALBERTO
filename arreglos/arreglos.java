...
public class arreglos {
    public static void main(String[] args) {
        ...
        double sumaPos = 0, sumaNeg = 0, promedio=0, alta=0, baja=0, suma=0;       
            ...
            System.out.println("3.- Lectura de 10 calificaciones de una asignatura para mostrar el promedio, la más alta, la más baja y la cantidad de aprobados y reprobados");
